...
class AdminManageEvents extends StatefulWidget {
  @override
  State<AdminManageEvents> createState() => _AdminManageEventsState();
}

class _AdminManageEventsState extends State<AdminManageEvents> {
  Stream? eventStream;
        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (context) =>
                      AdminViewEvent(eventId: eventId, viewMode: 'manage'),
            ),
          );
        },
        child: Card(
